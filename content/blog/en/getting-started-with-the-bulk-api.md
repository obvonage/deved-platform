---
title: Getting Started with the BULK API
...
Today, we are pleased to announce a new tool called [Bulk API](<>) that makes it easy to create outreach campaigns at a large scale using any Vonage Communication API such as Messages, Voice, and AI Studio. This API allows you to schedule and send personalized messages to different large-scale contact groups and offers the ability to receive and act on customer responses in a friendly GUI (Graphical User Interface). [Bulk API](<>) enters Beta today, and you can try it now from your [Vonage Developer Portal](https://developer.vonage.com/).

## Terminology

Once you log into your [Vonage Developer Portal](https://developer.vonage.com/), look under **Build & Manage**, and you will see **Bulk API**. Under **Configurations**, you'll see the following entries: Lists, Actions, Jobs, and Runs. Let's discuss what each of these means before moving forward. 
...
![Lists](/content/blog/getting-started-with-the-bulk-api/lists.png "lists.png")
...
![Map Labels to names defined in the CSV](/content/blog/getting-started-with-the-bulk-api/csvlabels.png "csvlabels.png")
...
![Configured List](/content/blog/getting-started-with-the-bulk-api/configuredlist.png "configuredlist.png")
...
![Pre-configured actions](/content/blog/getting-started-with-the-bulk-api/preconfigured-actions.png "preconfigured-actions.png")

This is where we can start seeing the power of **Bulk API**. If we select the **SMS** pre-configured Action, it will automatically populate the fields, such as the **parameters** we'd like to use in the request, along with the **Command** used for the API call and **Response** settings that come back after a successful or unsuccessful call. 

The image below shows the command and headers to send an SMS message via the Vonage APIs. 

![Pre-configured actions](/content/blog/getting-started-with-the-bulk-api/smsaction.png "smsaction.png")
...
![Pre-configured actions](/content/blog/getting-started-with-the-bulk-api/configure-actions.png "configure-actions.png")
...
![Create a Run](/content/blog/getting-started-with-the-bulk-api/create-a-run.png "create-a-run.png")
...
![Run Results](/content/blog/getting-started-with-the-bulk-api/run-results.png "run-results.png")

## Wrap-up

Now that you have successfully built your first campaign with sample data, you can begin to incorporating your live production data. But before we go, check out the [documentation](<>) for the product and if you have questions or feedback, join us on the [Vonage Developer Slack](https://developer.vonage.com/community/slack) and we will get back to you. Thanks again for reading, and I will catch you on the next one!